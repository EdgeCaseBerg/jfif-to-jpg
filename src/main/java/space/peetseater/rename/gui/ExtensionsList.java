...
public class ExtensionsList implements PropertyChangeListener {
    ...
    private BackgroundFileExtensionWorker worker;
    int filesSeen = 0;
    ...
    public void calculateExtensions(Path path) {
        ...
        worker = new BackgroundFileExtensionWorker(path);
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (BackgroundFileExtensionWorker.PROGRESS_PROPERTY_NAME.equals(evt.getPropertyName())) {
            updateLabelsFromProgressUpdate((BackgroundFileExtensionWorker.PartialResult) evt.getNewValue());
        }
    ...
    private void updateLabelsFromProgressUpdate(BackgroundFileExtensionWorker.PartialResult partial) {
